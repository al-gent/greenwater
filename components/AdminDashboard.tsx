    ...
    <div className="mt-4 space-y-3">
      <div>
        ...
        <textarea
          ...
          placeholder="e.g. Vessel not yet in our database, will add manually."
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              {pendingSubs} pending submission{pendingSubs !== 1 ? 's' : ''} · {pendingClaims} pending claim{pendingClaims !== 1 ? 's' : ''}
            </p>
          </div>
        ...
        <div className="flex items-center gap-1 bg-white rounded-2xl p-1 shadow-card mb-4 w-fit">
          {(['submissions', 'claims'] as Tab[]).map((t) => (
            <button
              key={t}
              onClick={() => setTab(t)}
                  ...
                  {claim.message && (
                    <div className="mt-3">
                      <button
                        ...
                        className="text-xs text-teal font-medium hover:underline"
                      >
                        {expandedDesc.has(claim.id) ? 'Hide message' : 'Show message'}
                      </button>
